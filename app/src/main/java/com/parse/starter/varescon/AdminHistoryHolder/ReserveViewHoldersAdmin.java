...
import com.parse.starter.varescon.History.HistoryRecycler.HistoryReserveDriverPage;
...
public class ReserveViewHoldersAdmin extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public ReserveViewHoldersAdmin(View itemView) {
        super(itemView);
                        ...
                        .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sweetAlertDialog) {
                                ...
                                final Runnable run = new Runnable() {
                                    ...
                                    public void run() {
                                        loadingbar.dismiss();
                                        ReserveHistoryAdmin.refreshData();
                                    }
                                };
        ...
        userHistoryRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    Log.e("key","called");
                    for (DataSnapshot d : dataSnapshot.getChildren()) {
                        DatabaseReference userHistoryRef = FirebaseDatabase.getInstance().getReference(Common.drivers).child(d.getKey()).child("history");
                        userHistoryRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                if (dataSnapshot.exists()) {
                                    for (DataSnapshot d : dataSnapshot.getChildren()) {
                                        if(d.getKey().equals(rideId)){
                                            ...
                                            userHistoryRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                                @Override
                                                public void onDataChange(final DataSnapshot dataSnapshotf) {
                                                    if (dataSnapshotf.exists()) {
                                                        DatabaseReference userHistoryRef = FirebaseDatabase.getInstance().getReference(Common.drivers);
                                                        userHistoryRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                                            @Override
                                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                                if (dataSnapshot.exists()) {
                                                                    for (DataSnapshot d : dataSnapshot.getChildren()) {
                                                                        if (d.getKey().equals(dataSnapshotf.child("driver").getValue().toString())) {
                                                                ...
                                                                if (dataSnapshot.exists()) {
                                                                    for (DataSnapshot d : dataSnapshot.getChildren()) {
                                                                        if (!d.getKey().equals(dataSnapshotf.child("driver").getValue().toString())) {
                                                                            ...
                                                                            Common.currentGetuid = dataSnapshotf.child("driver").getValue().toString();
                                                                        }
                                                                    }
                                                                }
                                                            }
    ...
    private void getDateAvail(final String driverKey, final String key, final String name) {
