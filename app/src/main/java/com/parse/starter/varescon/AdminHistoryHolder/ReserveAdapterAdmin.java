...
import com.parse.starter.varescon.History.HistoryRecycler.ReserveViewHoldersDriver;
...
public class ReserveAdapterAdmin extends RecyclerView.Adapter<ReserveViewHoldersAdmin> implements Filterable{
    private List<ReserveObjectDriver> itemList;
    private List<ReserveObjectDriver> filteredData;
    private Context context;
    private ReserveAdapterAdmin.ItemFilter mFilter = new ReserveAdapterAdmin.ItemFilter();

    public ReserveAdapterAdmin(List<ReserveObjectDriver> itemList, Context context) {
    ...
    @Override
    public ReserveViewHoldersAdmin onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ReserveViewHoldersAdmin rcv = new ReserveViewHoldersAdmin(layoutView);
        return rcv;
    }

    @Override
    public void onBindViewHolder(ReserveViewHoldersAdmin holder, int position) {
