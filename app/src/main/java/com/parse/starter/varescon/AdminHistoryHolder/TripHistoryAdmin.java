 ...
 */
public class TripHistoryAdmin extends Fragment {
    ...
    private void getUserHistoryId() {
        ...
        DatabaseReference userHistoryRef = FirebaseDatabase.getInstance().getReference("History");
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    if (dataSnapshot.child("type").getValue().equals("regular")) {
                        DatabaseReference userHistoryRef = FirebaseDatabase.getInstance().getReference(Common.drivers).child(dataSnapshot.child("driver").getValue().toString());
                        userHistoryRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot d) {
                                if (d.exists()) {
                                    ...
                                    Log.e("size", "" + mHistoryAdapter.getItemCount());
