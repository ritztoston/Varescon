 ...
 */
public class ReserveHistoryDriver extends Fragment {
    private String CustorDriver;
    private static String userId;
    private RecyclerView mReserveRecyclerView;
    private static ReserveAdapterDriver mReserveAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mReserveAdapter = new ReserveAdapterDriver(getDataSetReserve(), getContext());
